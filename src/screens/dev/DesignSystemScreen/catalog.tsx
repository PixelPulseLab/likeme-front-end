...
export function CatalogScroll({ bottomInset }: { bottomInset: number }) {
  ...
  return (
    ...
    >
      <View style={styles.intro}>
        ...
        <Text style={styles.introBody}>Catálogo dos componentes de UI do app.</Text>
      </View>
      ...
      <CatalogSection title='Campos'>
        <View style={styles.stack}>
          ...
          <TextInput label='Nome' value={name} onChangeText={setName} helperText='Campo usado em cadastros e busca.' />
