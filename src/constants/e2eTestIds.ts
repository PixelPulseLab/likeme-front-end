...
export const E2E_TEST_IDS = {
  ...
  INVITATION_CODE_INTERESTS: 'e2e.invitation.interestAreas',
  ONBOARDING_AVATAR_ROOT: 'e2e.onboarding.avatar',
  ...
  CHECKOUT_PAYMENT_METHOD_CARD: 'e2e.checkout.paymentMethod.creditCard',
  CHECKOUT_PAYMENT_METHOD_GOOGLE_PAY: 'e2e.checkout.paymentMethod.googlePay',
  CHECKOUT_PAYMENT_METHOD_APPLE_PAY: 'e2e.checkout.paymentMethod.applePay',
