...
export const E2E_TEST_IDS = {
  ...
  ACTIVITIES_SUBSCRIPTION_PREFIX: 'e2e.activities.subscription.',
  ...
  CART_BILLING_PERIOD_PREFIX: 'e2e.cart.billingPeriod.',
  ...
  CHECKOUT_VIEW_ORDERS: 'e2e.checkout.viewOrders',
