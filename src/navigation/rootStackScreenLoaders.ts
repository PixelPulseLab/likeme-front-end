...
export const getNotificationPreferencesScreen = (): RootStackScreen =>
  asScreen(require('../screens/profile/NotificationPreferencesScreen') as { default: RootStackScreen });
